...
var
  ...
  UCSRA: Byte absolute $C0;
  UCSRB: Byte absolute $C1;
  UCSRC: Byte absolute $C2;
  UBRR: Word absolute $C4;
  UBRRL: Byte absolute $C4;
  UBRRH: Byte absolute $C5;
  UDR: Byte absolute $C6;
