...
var
  // I/O Registers
  PRR: Byte absolute $00;      // Power Reduction Register
  ...
  TIFR1: Byte absolute $0B;    // Timer/Counter1 Interrupt Flag Register
  TIMSK1: Byte absolute $0C;   // Timer/Counter1 Interrupt Mask Register
  ...
  PCMSK0: Byte absolute $12;   // Pin Change Mask Register 0
  GPIOR0: Byte absolute $13;   // General Purpose I/O Register 0
  GPIOR1: Byte absolute $14;   // General Purpose I/O Register 1
  GPIOR2: Byte absolute $15;   // General Purpose I/O Register 2
  ...
  PCMSK1: Byte absolute $20;   // Pin Change Mask Register 1
  WDTCSR: Byte absolute $21;   // Watchdog Timer Control and Status Register
  TCCR1C: Byte absolute $22;   // Timer/Counter1 Control Register C
  GTCCR: Byte absolute $23;    // General Timer/Counter Control Register
  ICR1: Word absolute $24;     // Input Capture Register 1
  ICR1L: Byte absolute $24;    // Input Capture Register 1 Low
  ICR1H: Byte absolute $25;    // Input Capture Register 1 High
  CLKPR: Byte absolute $26;    // Clock Prescale Register
  DWDR: Byte absolute $27;     // DebugWire Data Register
  OCR1B: Word absolute $28;    // Output Compare Register 1 B
  OCR1BL: Byte absolute $28;   // Output Compare Register 1 B Low
  OCR1BH: Byte absolute $29;   // Output Compare Register 1 B High
  OCR1A: Word absolute $2A;    // Output Compare Register 1 A
  OCR1AL: Byte absolute $2A;   // Output Compare Register 1 A Low
  OCR1AH: Byte absolute $2B;   // Output Compare Register 1 A High
  OCRB1: Word absolute $28;    // Alias for OCR1B
  OCRB1L: Byte absolute $28;   // Alias for OCR1BL
  OCRB1H: Byte absolute $29;   // Alias for OCR1BH
  OCRA1: Word absolute $2A;    // Alias for OCR1A
  OCRA1L: Byte absolute $2A;   // Alias for OCR1AL
  OCRA1H: Byte absolute $2B;   // Alias for OCR1AH
  TCNT1: Word absolute $2C;    // Timer/Counter1
  TCNT1L: Byte absolute $2C;   // Timer/Counter1 Low
  TCNT1H: Byte absolute $2D;   // Timer/Counter1 High
  TCCR1B: Byte absolute $2E;   // Timer/Counter1 Control Register B
  TCCR1A: Byte absolute $2F;   // Timer/Counter1 Control Register A
  TCCR0A: Byte absolute $30;   // Timer/Counter0 Control Register A
  ...
  OCR0A: Byte absolute $36;    // Output Compare Register 0 A
  SPMCSR: Byte absolute $37;   // Store Program Memory Control and Status Register
  TIFR0: Byte absolute $38;    // Timer/Counter0 Interrupt Flag Register
  TIMSK0: Byte absolute $39;   // Timer/Counter0 Interrupt Mask Register
  GIFR: Byte absolute $3A;     // General Interrupt Flag Register
  GIMSK: Byte absolute $3B;    // General Interrupt Mask Register
  OCR0B: Byte absolute $3C;    // Output Compare Register 0 B
